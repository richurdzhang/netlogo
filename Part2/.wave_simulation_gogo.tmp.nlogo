...
A wave generator tank that generates different types of waves based on the user input. Virtual model demonstrate an ideal abstraction of wave, in order to give users a beter sense of amplitude and frequency.

## HOW IT WORKS

Use slider to control the servo rotation angle, enter time input to control the frequency (period) of wave. See how the real-life demonstration of wave with the virtual model, to make comparison and conceptualize the abstract terms of frequency and amplitude.

## HOW TO USE IT

Click setup to initialize the servo, as well as the virtual model. Change the servo_ang slider and time input to experiment different types of wave. 
